...
def parse_args():
    ...
    parser.add_argument("-z", "--z_dim", nargs=1, default=[7, 8, 9, 10, 11, 12, 13, 14], type=int, help="Set the dimension of the latent space")
    parser.add_argument("-i", "--max_iterations", nargs=1, default=[350], type=int, help="Set max epoch iteration")
    ...
    parser.add_argument("-e", "--error", nargs=1, default=[30], type=int, help="Quit training when error is reached!")
