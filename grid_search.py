...
def parse_args():
    ...
    parser.add_argument("-z", "--z_dim", nargs=1, default=[10, 11, 12, 13, 14], type=int, help="Set the dimension of the latent space")
    parser.add_argument("-i", "--max_iterations", nargs=1, default=[100], type=int, help="Set max epoch iteration")
    parser.add_argument("-o", "--output_dir", nargs=1, default=[''], type=str, help="Set output dir")
    parser.add_argument("-b", "--batch", nargs=1, default=[30], type=int, help="Batchsize")
    parser.add_argument("-e", "--error", nargs=1, default=[5], type=int, help="Quit training when error is reached!")
